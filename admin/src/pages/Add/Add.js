    ...
    <div className='add'>
      <form className='flex-col' onSubmit={onSubmitHandler}>
        ...
        <div className='add-product-name flex-col'>
            <p>Product name</p>
            <input onChange={onChangeHandler} value={data.value}  type="text" placeholder='Type here' name='name' />
        </div>
        ...
        <div className='add-price flex-col'>
            <p>Product price</p>
            <input onChange={onChangeHandler} type='number' name='price' value={data.price} placeholder='150' />
        </div>
        </div>
